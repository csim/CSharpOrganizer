...
public class OrganizeServiceTests
{
    ...
    private static void Execute(string code, string expectedCode)
    {
        string actualCode = OrganizeService.OrganizeCode(code);

        //Console.WriteLine(actualCode);
        Console.WriteLine(BitConverter.ToString(System.Text.Encoding.UTF8.GetBytes(actualCode)));
